...
export function ThemaMissies() {
  ...
  const missies = THEMA1_LESSEN.filter((l) => ritme.missies[l.id])
  if (missies.length === 0) return null
  ...
  return (
    <div className="flex flex-col gap-3">
      <div>
        <p className="text-caption font-bold uppercase tracking-wide text-ink-muted">Uit Contact maken</p>
