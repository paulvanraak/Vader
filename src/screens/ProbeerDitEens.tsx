...
export function ProbeerDitEens() {
  ...
  return (
    <div className="flex flex-col gap-5 px-5 py-6">
      <div>
        <p className="text-label text-ink-muted">Probeer dit eens</p>
        <h1 className="text-h2 text-ink">Jouw actielijst</h1>
              ...
              >
                <button
                  ...
                  className={`flex size-8 shrink-0 items-center justify-center rounded-full border-2 transition ${
                    isDone ? 'border-success-500 bg-success-500 text-neutral-white' : 'border-ink-faint text-transparent'
                  }`}
                >
                ...
                <button
                  ...
                  className="flex size-9 shrink-0 items-center justify-center rounded-full text-warning-500 hover:bg-surface-sunken"
                >
