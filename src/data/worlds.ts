import type { World } from '../types/lesson'

export const worlds: World[] = [
  { id: 1, title: 'Verbinding', subtitle: 'De basis van het contact' },
  { id: 2, title: 'Emoties', subtitle: 'Buien, stiltes en wat erachter zit' },
